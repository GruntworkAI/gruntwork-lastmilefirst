...
|--------|---------|-------------|
| [lastmilefirst](plugins/lastmilefirst/) | 0.31.0 | Opinionated structure and workflow for projects built by people and coding agents. Includes PARC, expert agents, operatives, stack-wisdom, and stack-knowledge. |
